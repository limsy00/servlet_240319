...
%>
	<div id="wrap" class="container">
         <header class="d-flex align-items-center">
	         ...
	         <!-- ●검색 -->
	         <div class="col-10"><!-- layout box -->
		         <form method="get" action="/lesson02/quiz10_info.jsp">
		         	<div class="input-group">
		                <input name="search" type="text" class="form-control col-6">
	         ...
	         <div class="d-flex border border-success p-3">
		         <div><img src="<%= target.get("thumbnail") %>" alt="앨범 표지" width="220"></div>
		         <div class="ml-4">
		         	<div class="title"><%= target.get("title") %></div>
		         	...
		         	<div class="text-secondary d-flex">
			         	...
			         	<div class="ml-4">
			         		...
			         		<div class="text-dark font-weight-bold">
			         			<%= (int)target.get("time") / 60 %> : <%= (int)target.get("time") % 60 %>
			         		</div>
	        ...
	        <!-- ●가사 -->
         	<h4 class="font-weight-bold mt-3">가사</h4>
         	<hr>
			<div>가사 정보 없음</div>
         </section>
         <hr>
         <footer class="d-flex align-items-center">Copyright 2024. Melong All Rights Reserved.</footer>
     </div>
</html>