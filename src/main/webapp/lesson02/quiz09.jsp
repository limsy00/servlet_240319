...
%>
	<div id="wrap" class="container">
         <header class="d-flex justify-content-center align-items-center">
         	<h1 class="text-danger font-weight-bold text-center">Sk Broadband IPTV</h1>
         </header>
         ...
         <footer class="d-flex justify-content-center align-items-center">Copyright 2024. Sk Broadband IPTV All Rights Reserved.</footer>
     </div>
</body>
</html>